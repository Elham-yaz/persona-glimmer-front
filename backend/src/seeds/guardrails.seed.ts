 ...
 * purely informational inquiry and a service-failure complaint, so nothing here presumes that
...
8. Protect privacy. Refer only to details of the customer's own order that appear in the reference information, and never ask for payment card numbers, passwords, or other sensitive personal data in the chat.`,
};
